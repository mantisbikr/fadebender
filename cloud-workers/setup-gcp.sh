...
echo ""
echo "3. Create Pub/Sub push subscription (authenticated OIDC):"
echo "   gcloud pubsub subscriptions create $SUBSCRIPTION_NAME \\"
echo "     --topic=$TOPIC_NAME \\"
echo "     --push-endpoint=\$SERVICE_URL \\"
echo "     --push-auth-service-account=$SERVICE_ACCOUNT@$PROJECT_ID.iam.gserviceaccount.com \\"
echo "     --push-auth-token-audience=\$SERVICE_URL \\"
